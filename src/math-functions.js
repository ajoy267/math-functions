...
export function sumAndMultiplyThreeNumbers(a, b, c) { //eslint-disable-line
    const adding = sum(sum(a, b)[0], c)[0];
    const multiplying = multiply(multiply(a, b)[0], c)[0];
    const str1 = `${a} and ${b} and ${c} sum to ${adding}.`;
    const str2 = `The product of ${a} and ${b} and ${c} is ${multiplying}.`;
    return [adding, multiplying, str1, str2];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const str = `The numbers ${multArr} have a product of ${multiply2}.`;
    return [multiply2, str];
}
...
export function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    //const multiply1 = multiply(dynamicArray[0], dynamicArray[1])[0];
    //const multiply2 = multiply(multiply1, dynamicArray[2])[0];
    //const multiply3 = multiply(multiply2, dynamicArray[3])[0];
    //const multiply4 = multiply(multiply3, dynamicArray[4])[0];
    //const str = `The numbers ${dynamicArray} have a product of ${multiply4}.`;
    //return [multiply4, str];
    //et arrayLength = dynamicArray.length - 1;
    //for(let multi of arrayLength) {
    //    multi = multiply(dynamicArray[arrayLength - 1], dynamicArray[arrayLength]);
    //}
    //const str = `The numbers ${dynamicArray} have a product of ${arrayLength}.`;
    //return [arrayLength, str];
}
